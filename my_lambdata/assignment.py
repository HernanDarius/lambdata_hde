...
def state_names(df):
    ...
    Return a copy of the original column with new column containing corresponding state names.

    '''
    df_state = df.copy()

    names = {'CA': 'California', 'CO':'Colorado','CT':'Connecticut','DC':'District of Columbia', 'TX':'Texas'}
